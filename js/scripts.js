...
// var xxx = $('#homeUserText').val();
// var xxxarray = xxx.split('')
// var textarea = $('#homeUserText')
// console.log(typeof(textarea))

// function keypressed(elem){
//    return elem.addEventListener('keydown', function(e){
//        if ((e.key).length === 1) {
//            xxxarray.push(e.key)
//        } if (e.key === "Backspace") {
//            xxxarray.pop(e.key)
...
// console.log(keypressed(textarea))

// // $('#homeUserText').on('keydown', function (e) {
// //     if ((e.key).length === 1) {
// //         xxxarray.push(e.key)
// //     } if (e.key === "Backspace") {
// //         xxxarray.pop(e.key)
// //     }
// //     console.log(xxxarray)
// // });

// // if (xxxarray.length === 40) {
// //     alert('40 chars reached')
// // }
